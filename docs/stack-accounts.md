...
These accounts are required for Phabricator image installation and configuration

## Phabricator

Administrator account is set by yourselft at the time of Phabricator installation wizard
